...
<?php if ( ! WC()->cart->is_empty() ) : ?>
						...
						<div class="cart-product-body et-clearfix">
							...
							<div class="cart-product-content">
								...
								<div class="cart-product-data">
									...
									<ul class="cart-data">
										<li>
											<span class='attribute'><?php echo esc_html__('Quantity:', 'textron'); ?></span>
	...
	<div class="woocommerce-mini-cart-info-wrap">
		...
		<p class="woocommerce-mini-cart-info woocommerce-mini-cart__total total">
			<span class="subtotal-label"><?php echo esc_html__( 'Subtotal', 'textron' ); ?>:</span>
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart-info woocommerce-mini-cart__empty-message">
		<?php echo esc_html__( 'No products in the cart.', 'textron' ); ?>
	</p>
