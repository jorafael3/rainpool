<?php
	...
	function enovathemes_addons_header_custom_columns($column){
        ...
        $desktop_header_id = (isset($GLOBALS['textron_enovathemes']['header-desktop-id']) && !empty($GLOBALS['textron_enovathemes']['header-desktop-id'])) ? $GLOBALS['textron_enovathemes']['header-desktop-id'] : "none";
        $mobile_header_id  = (isset($GLOBALS['textron_enovathemes']['header-mobile-id']) && !empty($GLOBALS['textron_enovathemes']['header-mobile-id'])) ? $GLOBALS['textron_enovathemes']['header-mobile-id'] : "none";
