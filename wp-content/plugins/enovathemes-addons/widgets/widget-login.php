<?php
	...
	class  Enovathemes_Addons_WP_Widget_Login extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			?>
			<span><?php echo esc_html__('Hello, ', 'enovathemes-addons').$user; ?></span><br>
			<a class="et-button button small logout-button" href="<?php echo wp_logout_url( get_permalink(home_url('/')) ); ?>" title="<?php echo esc_html__('Logout', 'enovathemes-addons'); ?>"><?php echo esc_html__('Logout', 'enovathemes-addons'); ?></a>
			<?php } else {
				wp_login_form( $args );
