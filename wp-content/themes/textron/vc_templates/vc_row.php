...
if ( $has_video_bg ) {
	...
	$row_background = '<video class="video-container" autoplay preload="auto" loop="loop" muted="muted" poster="'.TEXTRON_ENOVATHEMES_IMAGES.'/transparent.png">';
		if ($video_bg_mp4){
...
if ($curtain != "none") {
	$row_background .= '<div class="vc-curtain" data-curtain="'.esc_attr($curtain).'"></div>';
	if ($curtain_color) {$color = $curtain_color;}
}
if (!empty($color)) {
