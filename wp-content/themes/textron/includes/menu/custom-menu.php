...
class ET_Textron_Custom_Menu {
	...
	function __construct() {
		...
		add_filter( 'wp_setup_nav_menu_item', array( $this, 'textron_enovathemes_scm_add_custom_nav_fields' ) );

		// save menu custom fields
		add_action( 'wp_update_nav_menu_item', array( $this, 'textron_enovathemes_scm_update_custom_nav_fields'), 10, 3 );
		
		// edit menu walker
		add_filter( 'wp_edit_nav_menu_walker', array( $this, 'textron_enovathemes_scm_edit_walker'), 10, 2 );
	 ...
	 * @return      void
	*/
	function textron_enovathemes_scm_add_custom_nav_fields( $menu_item ) {
	 ...
	 * @return      void
	*/
	function textron_enovathemes_scm_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
	 ...
	 * @return      void
	*/
	function textron_enovathemes_scm_edit_walker($walker,$menu_id) {
...
$GLOBALS['custom_menu'] = new ET_Textron_Custom_Menu();
