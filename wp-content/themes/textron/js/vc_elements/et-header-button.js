                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_header_button"]').length) {
                        ...
                        ---------------*/
                            ...
                            if (icon_margin.length) {
                                CSS += '#et-header-button-'+ID+' a.icon-position-left .icon {margin-right:'+icon_margin+'px;}';
                                CSS += '#et-header-button-'+ID+' a.icon-position-right .icon {margin-left:'+icon_margin+'px;}';
                            }
                            ...
                            if (button_color.length) {
                                CSS += '#et-header-button-'+ID+' .icon svg, #et-header-button-'+ID+' .icon svg * {';
                            ...
                            if (button_color_hover.length) {
                                if (animate_hover != "fill") {
                                    CSS += '#et-header-button-'+ID+' a:hover {';
                                        CSS += 'color:'+button_color_hover+';';
                                    CSS += '}';

                                    CSS += '#et-header-button-'+ID+' a:hover .icon svg, #et-header-button-'+ID+' a:hover .icon svg * {';
                            ...
                            if (button_back_color.length) {
                                ...
                                if (button_style == 'outline') {
                                    CSS += '#et-header-button-'+ID+' .regular {';
                                        CSS += 'stroke:'+button_back_color+';';
                                    CSS += '}';
                                } else {
                                    CSS += '#et-header-button-'+ID+' .regular {';
                                        CSS += 'fill:'+button_back_color+';';
                                    CSS += '}';
                                }
                            }
                            ...
                            if (button_back_color_hover.length) {
                                if (animate_hover == "fill") {
                                    CSS += '#et-header-button-'+ID+' .hover {';
                                        CSS += 'fill:'+button_back_color_hover+';';
                                    CSS += '}';
                                } else {

                                    if (button_style == 'outline') {
                                        CSS += '#et-header-button-'+ID+' a:hover .regular {';
                                            CSS += 'stroke:'+button_back_color_hover+';';
                                        CSS += '}';
                                    } else {
                                        CSS += '#et-header-button-'+ID+' a:hover .regular {';
                                            CSS += 'fill:'+button_back_color_hover+';';
