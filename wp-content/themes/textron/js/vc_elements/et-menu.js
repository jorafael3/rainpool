(function($){
    ...
    //TO BE CHANGED !!!!!!!
    function refreshTabCarousel(tab){
                        ...
                        if (action == 'click') {
                            tabs.on('click', function(event){
                                ...
                                if(!$self.hasClass("active")){
                                    ...
                                    refreshTabCarousel(tabsContent.eq($self.index()));
                                }
                            });
                        } else {
                    ...
                    if ($('#vc_ui-panel-edit-element[data-vc-shortcode="et_menu"]').length) {
                        ...
                        ---------------*/
                            ...
                            if (menu_separator.length && menu_separator_color.length) {
                                ...
                                if (menu_space.length) {
                                    ...
                                    CSS += '#et-menu-'+ID+' dir-child* .menu-item.depth-0 {margin-left:'+(menu_space/2)+'px !important;margin-right:'+(menu_space/2)+'px !important;}';
                                }
                        ...
                        ---------------*/
                            ...
                            if (submenuoffset.length) {
                                CSS += '.submenu-appear-from-bottom #et-menu-'+ID+' dir-child* .menu-item dir-child* .sub-menu {top:'+submenuoffset+' !important;}';
                                CSS += '.submenu-appear-from-top #et-menu-'+ID+' dir-child* .menu-item dir-child* .sub-menu {bottom:'+submenuoffset+' !important;}';
                            }
